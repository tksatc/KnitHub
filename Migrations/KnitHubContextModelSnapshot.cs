...
namespace KnitHub.Migrations
{
    ...
    partial class KnitHubContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("KnitHub.Models.Pattern", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PatternId = 1,
                            CategoryId = 5,
                            DateUpdated = new DateTime(2021, 10, 15, 14, 0, 39, 245, DateTimeKind.Local).AddTicks(46),
                            DesignerId = 3,
                            ManufacturerId = 9,
                            Name = "Rosemarie",
                            SkillLevelId = 4,
                        ...
                        new
                        {
                            PatternId = 2,
                            CategoryId = 5,
                            DateUpdated = new DateTime(2021, 10, 15, 14, 0, 39, 245, DateTimeKind.Local).AddTicks(1191),
                            DesignerId = 2,
                            ManufacturerId = 8,
                            Name = "Simple Tee",
                            SkillLevelId = 3,
                        ...
                        new
                        {
                            PatternId = 3,
                            CategoryId = 5,
                            DateUpdated = new DateTime(2021, 10, 15, 14, 0, 39, 245, DateTimeKind.Local).AddTicks(1230),
                            DesignerId = 1,
                            ManufacturerId = 7,
                            Name = "Gretel",
                            SkillLevelId = 3,
            ...
            modelBuilder.Entity("KnitHub.Models.Yarn", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            YarnId = 1,
                            DateUpdated = new DateTime(2021, 10, 15, 14, 0, 39, 243, DateTimeKind.Local).AddTicks(6783),
                            FiberTypeId = 3,
                            FiberWeightId = 3,
                            ManufacturerId = 1,
                            Name = "Arya Ebruli",
                        ...
                        {
                            YarnId = 2,
                            DateUpdated = new DateTime(2021, 10, 15, 14, 0, 39, 244, DateTimeKind.Local).AddTicks(4499),
                            FiberTypeId = 4,
                            FiberWeightId = 6,
                            ManufacturerId = 2,
                            Name = "Brushed Fleece",
                        ...
                        {
                            YarnId = 3,
                            DateUpdated = new DateTime(2021, 10, 15, 14, 0, 39, 244, DateTimeKind.Local).AddTicks(4562),
                            FiberTypeId = 19,
                            FiberWeightId = 1,
                            ManufacturerId = 3,
                            Name = "Silk Cloud",
            ...
            modelBuilder.Entity("KnitHub.Models.YarnDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            YarnDetailId = 1,
                            DateUpdated = new DateTime(2021, 10, 15, 14, 0, 39, 244, DateTimeKind.Local).AddTicks(5164),
                        ...
                        {
                            YarnDetailId = 2,
                            DateUpdated = new DateTime(2021, 10, 15, 14, 0, 39, 244, DateTimeKind.Local).AddTicks(6228),
                        ...
                        {
                            YarnDetailId = 3,
                            DateUpdated = new DateTime(2021, 10, 15, 14, 0, 39, 244, DateTimeKind.Local).AddTicks(6279),
