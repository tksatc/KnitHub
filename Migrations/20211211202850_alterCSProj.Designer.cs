...
namespace KnitHub.Migrations
{
    ...
    [Migration("20211211202850_alterCSProj")]
    partial class alterCSProj
    {
            ...
            modelBuilder.Entity("KnitHub.Models.Pattern", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PatternId = 1,
                            CategoryId = 5,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 28, 49, 753, DateTimeKind.Local).AddTicks(7884),
                            DesignerId = 3,
                            ManufacturerId = 9,
                            Name = "Rosemarie",
                            SkillLevelId = 4,
                        ...
                        new
                        {
                            PatternId = 2,
                            CategoryId = 5,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 28, 49, 753, DateTimeKind.Local).AddTicks(9029),
                            DesignerId = 2,
                            ManufacturerId = 8,
                            Name = "Simple Tee",
                            SkillLevelId = 3,
                        ...
                        new
                        {
                            PatternId = 3,
                            CategoryId = 5,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 28, 49, 753, DateTimeKind.Local).AddTicks(9071),
                            DesignerId = 1,
                            ManufacturerId = 7,
                            Name = "Gretel",
                            SkillLevelId = 3,
            ...
            modelBuilder.Entity("KnitHub.Models.Yarn", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            YarnId = 1,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 28, 49, 752, DateTimeKind.Local).AddTicks(5266),
                            FiberTypeId = 3,
                            FiberWeightId = 3,
                            ManufacturerId = 1,
                            Name = "Arya Ebruli",
                        ...
                        {
                            YarnId = 2,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 28, 49, 753, DateTimeKind.Local).AddTicks(2397),
                            FiberTypeId = 4,
                            FiberWeightId = 6,
                            ManufacturerId = 2,
                            Name = "Brushed Fleece",
                        ...
                        {
                            YarnId = 3,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 28, 49, 753, DateTimeKind.Local).AddTicks(2461),
                            FiberTypeId = 19,
                            FiberWeightId = 1,
                            ManufacturerId = 3,
                            Name = "Silk Cloud",
            ...
            modelBuilder.Entity("KnitHub.Models.YarnDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            YarnDetailId = 1,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 28, 49, 753, DateTimeKind.Local).AddTicks(3055),
                        ...
                        {
                            YarnDetailId = 2,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 28, 49, 753, DateTimeKind.Local).AddTicks(4267),
                        ...
                        {
                            YarnDetailId = 3,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 28, 49, 753, DateTimeKind.Local).AddTicks(4299),
