...
namespace KnitHub.Migrations
{
    ...
    [Migration("20211028170613_AddedAnnotations")]
            ...
            modelBuilder.Entity("KnitHub.Models.Pattern", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PatternId = 1,
                            CategoryId = 5,
                            DateUpdated = new DateTime(2021, 10, 28, 9, 6, 13, 94, DateTimeKind.Local).AddTicks(9233),
                            DesignerId = 3,
                            ManufacturerId = 9,
                            Name = "Rosemarie",
                            SkillLevelId = 4,
                        ...
                        new
                        {
                            PatternId = 2,
                            CategoryId = 5,
                            DateUpdated = new DateTime(2021, 10, 28, 9, 6, 13, 95, DateTimeKind.Local).AddTicks(438),
                            DesignerId = 2,
                            ManufacturerId = 8,
                            Name = "Simple Tee",
                            SkillLevelId = 3,
                        ...
                        new
                        {
                            PatternId = 3,
                            CategoryId = 5,
                            DateUpdated = new DateTime(2021, 10, 28, 9, 6, 13, 95, DateTimeKind.Local).AddTicks(481),
                            DesignerId = 1,
                            ManufacturerId = 7,
                            Name = "Gretel",
                            SkillLevelId = 3,
            ...
            modelBuilder.Entity("KnitHub.Models.Yarn", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            YarnId = 1,
                            DateUpdated = new DateTime(2021, 10, 28, 9, 6, 13, 93, DateTimeKind.Local).AddTicks(6402),
                            FiberTypeId = 3,
                            FiberWeightId = 3,
                            ManufacturerId = 1,
                            Name = "Arya Ebruli",
                        ...
                        {
                            YarnId = 2,
                            DateUpdated = new DateTime(2021, 10, 28, 9, 6, 13, 94, DateTimeKind.Local).AddTicks(3536),
                            FiberTypeId = 4,
                            FiberWeightId = 6,
                            ManufacturerId = 2,
                            Name = "Brushed Fleece",
                        ...
                        {
                            YarnId = 3,
                            DateUpdated = new DateTime(2021, 10, 28, 9, 6, 13, 94, DateTimeKind.Local).AddTicks(3594),
                            FiberTypeId = 19,
                            FiberWeightId = 1,
                            ManufacturerId = 3,
                            Name = "Silk Cloud",
            ...
            modelBuilder.Entity("KnitHub.Models.YarnDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            YarnDetailId = 1,
                            DateUpdated = new DateTime(2021, 10, 28, 9, 6, 13, 94, DateTimeKind.Local).AddTicks(4211),
                        ...
                        {
                            YarnDetailId = 2,
                            DateUpdated = new DateTime(2021, 10, 28, 9, 6, 13, 94, DateTimeKind.Local).AddTicks(5400),
                        ...
                        {
                            YarnDetailId = 3,
                            DateUpdated = new DateTime(2021, 10, 28, 9, 6, 13, 94, DateTimeKind.Local).AddTicks(5439),
