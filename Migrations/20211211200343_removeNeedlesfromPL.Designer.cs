...
namespace KnitHub.Migrations
{
    ...
    [Migration("20211211200343_removeNeedlesfromPL")]
    partial class removeNeedlesfromPL
    {
            ...
            modelBuilder.Entity("KnitHub.Models.Pattern", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PatternId = 1,
                            CategoryId = 5,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 3, 43, 282, DateTimeKind.Local).AddTicks(2319),
                            DesignerId = 3,
                            ManufacturerId = 9,
                            Name = "Rosemarie",
                            SkillLevelId = 4,
                        ...
                        new
                        {
                            PatternId = 2,
                            CategoryId = 5,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 3, 43, 282, DateTimeKind.Local).AddTicks(3502),
                            DesignerId = 2,
                            ManufacturerId = 8,
                            Name = "Simple Tee",
                            SkillLevelId = 3,
                        ...
                        new
                        {
                            PatternId = 3,
                            CategoryId = 5,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 3, 43, 282, DateTimeKind.Local).AddTicks(3550),
                            DesignerId = 1,
                            ManufacturerId = 7,
                            Name = "Gretel",
                            SkillLevelId = 3,
            ...
            modelBuilder.Entity("KnitHub.Models.Yarn", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            YarnId = 1,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 3, 43, 280, DateTimeKind.Local).AddTicks(9314),
                            FiberTypeId = 3,
                            FiberWeightId = 3,
                            ManufacturerId = 1,
                            Name = "Arya Ebruli",
                        ...
                        {
                            YarnId = 2,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 3, 43, 281, DateTimeKind.Local).AddTicks(6530),
                            FiberTypeId = 4,
                            FiberWeightId = 6,
                            ManufacturerId = 2,
                            Name = "Brushed Fleece",
                        ...
                        {
                            YarnId = 3,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 3, 43, 281, DateTimeKind.Local).AddTicks(6591),
                            FiberTypeId = 19,
                            FiberWeightId = 1,
                            ManufacturerId = 3,
                            Name = "Silk Cloud",
            ...
            modelBuilder.Entity("KnitHub.Models.YarnDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            YarnDetailId = 1,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 3, 43, 281, DateTimeKind.Local).AddTicks(7434),
                        ...
                        {
                            YarnDetailId = 2,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 3, 43, 281, DateTimeKind.Local).AddTicks(8674),
                        ...
                        {
                            YarnDetailId = 3,
                            DateUpdated = new DateTime(2021, 12, 11, 12, 3, 43, 281, DateTimeKind.Local).AddTicks(8707),
